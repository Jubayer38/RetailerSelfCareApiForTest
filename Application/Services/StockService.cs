...
namespace Application.Services
{
    public class StockService : IDisposable
    {
        ...
        public async Task<RetailerSessionCheck> CheckRetailerByCode(string retailerCode, string loginProvider)
        {
            ...
            {
                throw new Exception(HelperMethod.ExMsgBuild(ex, "CheckRetailerByCode"));
            }
        }
        ...
        public DataTable GetScStockDetails(StockDetialRequest request)
        {
            try
            {
                var result = _repo.GetScStockDetails(request);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public DataTable GetSimStockDetails(StockDetialRequest request)
        {
            ...
            {
                throw new Exception(HelperMethod.ExMsgBuild(ex, "GetSimStockDetails"));
            }
        }
        ...
        public EvXmlResponse GetITOPUPStockSummary(ItopUpXmlRequest xmlRequest, StockDetialRequest stockDetialRequest)
        {
            ...
            {
                throw new Exception(HelperMethod.ExMsgBuild(ex, "GetITOPUPStockSummaryData"));
            }
        }
        ...
        {
            var result = _repo.UpdateItopUpBalance(model);
            return result;
        }
        ...
        public DataTable ScExpire(string retailerCode)
        {
            ...
            {
                throw new Exception(HelperMethod.ExMsgBuild(ex, "ScExpire"));
            }
        }
        ...
        public DataTable GetRetailerByCode(string retailerCode)
        {
            ...
            try
            {
                var result = _repo.GetRetailerByCode(retailerCode);
                return result;
            }
            catch (Exception ex)
            {
                throw new Exception(HelperMethod.ExMsgBuild(ex, "GetRetailerByCode"));
            }
        }
        ...
        public string GetITOPUPBalance(ItopUpXmlRequestV2 xmlRequest, RetailerRequestV2 stockDetialRequest, string userAgent)
        {
            ...
            evLog = HelperMethod.LogModelBind(stockDetialRequest, evLog, "GetITOPUPBalance", userAgent);
        ...
        private string BuildEvPinLessBlncReqBody(ItopUpXmlRequestV2 xmlRequest)
        {
        ...
        {
            return await _repo.GetRSOAndLastTime(reqModel);
        }
        ...
        public string GetITopUpBalanceNew(RSOEligibility rsoEligibility, ItopUpXmlRequestV2 xmlRequest, string userAgent)
        {
            LoggerService loggerService = new();
            EvLogViewModel evLog = new();
            evLog = HelperMethod.LogModelBind(xmlRequest, evLog, "GetITopUpBalanceNew", userAgent);
            evLog.subMSISDN = string.Empty;
        ...
        private EvXmlResponse GetITOPUPStockSummaryData(ItopUpXmlRequest xmlRequest, StockDetialRequest stockDetialRequest)
        {
            EvLogViewModel evLog = new()
            {
        ...
        private string GetItopUpBalReqXML(ItopUpXmlRequest xml)
        {
