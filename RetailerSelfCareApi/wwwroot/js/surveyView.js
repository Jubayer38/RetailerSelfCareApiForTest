    ...
    $(function () {
        ...
        function generateQuestions() {
            if (surveyQuestions.length > 0) {
                ...
                var submitSection = '<div class="card mb-2 text-right">' +
        ...
        function textFieldBuilder(question) {
            var literal = '<div class="card mb-2 question" id="' + question.id + '" data-question-id="' + question.id + '" data-question-type="' + question.input_type + '" data-is-required="' + question.isRequired + '">'
                + '<div class="d-flex align-content-start p-2">'
                + '<label class="form-label" id="' + question.id + '">' + question.quesOrder + '.' + question.ques_descrip + '</label>'
                + '</div>'
        ...
        function checkboxSingleBuilder(question) {
            ...
            var literal =
                ...
                '" data-question-type="' + question.input_type + '"data-is-required="' + question.isRequired + '"><div class="d-flex align-content-start p-2"><label class="form-label" data-is-required="' + question.isRequired + '">' +
        ...
        function checkboxMultipleBuilder(question) {
            ...
            var literal =
                ...
                '" data-question-type="' + question.input_type + '"data-is-required="' + question.isRequired + '"><div class="d-flex align-content-start p-2"><label class="form-label">' +
                question.quesOrder + '. ' + question.ques_descrip + '</label ></div>' + checkOptions +
                '<div id="' + question.id + '_error" class="err hideError" style="padding-top: 3px;"><svg xmlns="http://www.w3.org/2000/svg" class="errCaution" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>' +
                '<span style="padding-left: 3px;">Please response to this question</span>' +
                '</div></div>';
        ...
        function radioBuilder(question) {
            ...
            var literal =
                '<div class="card mb-3 question" id="' + question.id + '" data-question-id="' + question.id + '" data-question-type="' + question.input_type + '"data-is-required="' + question.isRequired + '"><div class="d-flex align-content-start p-2"><label class="form-label">' +
        ...
        function dateTimeBuilder(question) {
            ...
            var literal = '<div class="card mb-3 question" id="' + question.id + '" data-question-id="' + question.id + '" data-question-type="' + question.input_type + '" data-is-required="' + question.isRequired + '">'
                + '<div class="d-flex align-content-start p-2">'
                ...
                + '<label for="' + question.id + 'date" style="padding-left: 2.2rem;">Date</label>'
                + '</div>'

                + '<div class="form-floating mb-3 col-md-3 lrPad">'
                + '<input type="text" class="form-control" id="' + question.id + 'time">'
                + '<label for="' + question.id + 'time" style="padding-left: 2.2rem;">Time</label>'
                + '</div>'
                + '</div>'
                + '<div id="' + question.id + '_error" class="err hideError">'
                + '<svg xmlns="http://www.w3.org/2000/svg" class="errCaution" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'
        ...
        function linearScaleBuilder(question) {
            ...
            for (var i = question.linear_start_value; i <= question.linear_end_value; i++) {
                linearNumber += '<td style="border: none;min-width:2rem;text-align:center;overflow-wrap: break-word;">' + i + '</td>';
            ...
            var literal = '<div class="card mb-2 question" id="' + question.id + '" data-question-id="' + question.id + '" data-question-type="' + question.input_type + '"data-is-required="' + question.isRequired + '">' +
                ...
                '</tr>' +
                '<tr>' +
                '<td style="border: none;min-width:2rem;text-align:right;overflow-wrap: break-word;">' + question.linear_start_level_txt + '</td>' +
                linearCheckbox +
                '<td style="border: none;min-width:2rem;text-align:left;overflow-wrap: break-word;">' + question.linear_end_level_txt + '</td>' +
                '</tr></tbody></table></div>' +
                '<div id="' + question.id + '_error" class="err hideError" style="padding-top: 3px;"><svg xmlns="http://www.w3.org/2000/svg" class="errCaution" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>' +
                '<span style="padding-left: 3px;">Please response to this question</span>' +
                '</div></div>';
        ...
        function multipleChoiceGrid(question) {
            ...
            for (var i = 0; i < question.columns.length; i++) {
                choiceOption += '<td style="border: none;min-width: 2rem;text-align: center;overflow-wrap: break-word !important;" class="' + question.columns[i].id + '">' + question.columns[i].name + '</td>';
            }

            for (var i = 0; i < question.rows.length; i++) {

                choiceGrid += '<tr data-row-name="' + question.rows[i].name + '" id="' + question.id + "Row" + (i + 1) + '" class="optionRow"><td style="border: none;min-width: 2rem;text-align: left;overflow-wrap: break-word;">' + question.rows[i].name + '</td>';
        ...
        function multipleCheckboxGrid(question) {
            ...
            for (var i = 0; i < question.columns.length; i++) {
                checkboxOption += '<td style="border: none; min-width: 2rem;text-align: center;overflow-wrap: break-word;" class="' + question.columns[i].id + '">' + question.columns[i].name + '</td>';
            }

            for (var i = 0; i < question.rows.length; i++) {

                var rowNo = "Row" + (i + 1);
                checkboxGrid += '<tr data-row-name="' + question.rows[i].name + '" id="' + question.id + rowNo + '" class="optionRow"><td style="border: none;min-width: 3rem;text-align: left;overflow-wrap: break-word;">' + question.rows[i].name + '</td>';
