...
namespace RetailerSelfCareApi.Controllers.v2
{
    ...
    public class LiftingController : ControllerBase
    {
        ...
        public async Task<IActionResult> Lifting([FromBody] LiftingRequest liftingRequest)
        {
            ...
            LiftingV2Service liftingService;
            ...
            if (lifting > 0)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    traceMsg = HelperMethod.BuildTraceMessage(traceMsg, "SubmitExternalRequest", ex);
                }
            }
            ...
            if (!string.IsNullOrWhiteSpace(traceMsg))
            {
                ...
                _logger.WriteTraceMessageInText(liftingRequest, "v2/Lifting", traceMsg);
            }
